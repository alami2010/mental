...
class ChantierDetailsUser extends StatefulWidget {
  ...
  const ChantierDetailsUser({required this.chantier}) : super();

  @override
  State<ChantierDetailsUser> createState() => _ChantierDetailsUserState();
}

class _ChantierDetailsUserState extends State<ChantierDetailsUser> {
  @override
  void initState() {
    super.initState();
  }
